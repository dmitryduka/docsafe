...
// Release signing credentials are kept out of source control in keystore.properties.
...
android {
    ...
    lint {
        // Incomplete locales fall back to English; don't fail release builds on it.
